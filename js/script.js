$(".menu>ul>li").click(function(){
 ...
 // attr > attribute : 호출하다.
 // this에  menu>ul>li값을 담은 후 data-filter값을 호출하여 i에 담아준다.

$(this).addClass("active")
// this == .menu>ul>li를 정의한것 
// this에 daaClass >> 새로운 클래스 값을 부여
...
// 두번째 gallery_box를 클릭하면 popup_wrap과 p2이 떠야함.
// p_close를 클릭하면 닫히기

$(".gallery_box").click(function(){
  // 갤러리 박스를 클릭했을 때,
  let Index = $(".gallery_box").index($(this));
  // let Index = $(".gallery_box").index($(this)); >> 몇번째 갤러리 박스를 클릭했는지 입력받은 후 this에 저장
  // 위에 저장된 값을 Index라는 변수에 저장
  $("body").css("height","100%")
